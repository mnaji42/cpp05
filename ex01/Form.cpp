...
/*   Updated: 2020/03/08 02:29:46 by mnaji            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
Form::Form(std::string name, int grade, int execGrade): _name(name), _signed(false), _grade(grade), _execGrade(execGrade)
{
...
Form::Form(const Form &F): _name(F._name), _signed(F._signed), _grade(F._grade), _execGrade(F._execGrade)
{
}
